...
TARGET ROLES
AI/ML Engineer · MLOps Engineer · Big Data Engineer

KEY SKILLS
Python · PyTorch · Transformers · Reinforcement Learning · RAG · Kafka · Spark · Airflow · FastAPI · Docker · Kubernetes

HIGHLIGHTS
- Fleet data pipeline: real-time Kafka + Spark Structured Streaming, Airflow batch, FastAPI dashboard, DLQ handling.
- Hospital Bed Allocation (Final Year): multi-agent MAPPO for fair allocation; automated retraining pipeline.
- Agentic RAG system: grounded research answers using ChromaDB + MCP; containerized with CI.
